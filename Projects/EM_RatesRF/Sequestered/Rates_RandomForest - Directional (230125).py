...
for country in rate_decisions.columns:
    ...
    n_top_features = 6  # Adjust this number based on your requirement
   ...
   # Create a mapping from numerical labels to bin labels
    ...
    f'policy_rate_change_{country_code}': y_test})
    #comparison_df.to_csv(f"{country_code}_comparison.csv", index=True)
