...
for country in rate_decisions.columns:
    ...
    base_rf_model = RandomForestClassifier(random_state=42, oob_score=True, max_depth=30)
    ...
    rf_model = RandomForestClassifier(random_state=42, oob_score=True, max_depth=30)

    # Train the initial Random Forest model
    initial_rf_model = RandomForestClassifier(random_state=42, oob_score=True, max_depth=30)
